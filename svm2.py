"""
Support Vector Machine (SVM) Baseline for Robust Dataset Testing
...
OUTPUT_RESULTS_DIR = PROJECT_ROOT / "results2" / "svm"
...
def run_all():
    ...
    logging.info("Starting SVM (RBF Kernel) Robust Baseline Backtest Engine...")
